...
// function game() {
    ...
    switch (prompt) {
        ...
        case 'e':
            var club = "club"
            playerInv.push(club)
            const prompt2 = readline.keyIn("you pick the club up off the ground feeling a little better now that your armed there dosent appear to be anything else in the cell with you only the open door is of any interest. press 'w' to walk through the door" )
            break 
    }
// }
